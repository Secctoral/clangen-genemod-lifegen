...
class ProfileScreen(Screens):
                    ...
                    if cat.pelt.inventory:
                        for a, accessory in enumerate(new_inv[start_index:min(end_index, inventory_len + start_index)], start = start_index):
                            if accessory in cat.pelt.accessories:
                                self.accessory_buttons[str(i)] = UIImageButton(ui_scale(pygame.Rect((100 + pos_x, 365 + pos_y), (100, 100))), "", tool_tip_text=accessory, object_id="#fav_marker")
                            else:
                                self.accessory_buttons[str(i)] = UIImageButton(ui_scale(pygame.Rect((100 + pos_x, 365 + pos_y), (100, 100))), "", tool_tip_text=accessory, object_id="#blank_button")
                            if accessory in cat.pelt.plant_accessories:
                                self.cat_list_buttons["cat" + str(i)] = pygame_gui.elements.UIImage(ui_scale(pygame.Rect((100 + pos_x, 365 + pos_y), (100, 100))), sprites.sprites['acc_herbs' + accessory + cat_sprite], manager=MANAGER)
                            elif accessory in cat.pelt.wild_accessories:
                                self.cat_list_buttons["cat" + str(i)] = pygame_gui.elements.UIImage(ui_scale(pygame.Rect((100 + pos_x, 365 + pos_y), (100, 100))), sprites.sprites['acc_wild' + accessory + cat_sprite], manager=MANAGER)
                            elif accessory in cat.pelt.collars:
                                self.cat_list_buttons["cat" + str(i)] = pygame_gui.elements.UIImage(ui_scale(pygame.Rect((100 + pos_x, 365 + pos_y), (100, 100))), sprites.sprites['collars' + accessory + cat_sprite], manager=MANAGER)
                            elif accessory in cat.pelt.flower_accessories:
                                self.cat_list_buttons["cat" + str(i)] = pygame_gui.elements.UIImage(ui_scale(pygame.Rect((100 + pos_x, 365 + pos_y), (100, 100))), sprites.sprites['acc_flower' + accessory + cat_sprite], manager=MANAGER)
                            elif accessory in cat.pelt.plant2_accessories:
                                self.cat_list_buttons["cat" + str(i)] = pygame_gui.elements.UIImage(ui_scale(pygame.Rect((100 + pos_x, 365 + pos_y), (100, 100))), sprites.sprites['acc_plant2' + accessory + cat_sprite], manager=MANAGER)
                            elif accessory in cat.pelt.snake_accessories:
                                self.cat_list_buttons["cat" + str(i)] = pygame_gui.elements.UIImage(ui_scale(pygame.Rect((100 + pos_x, 365 + pos_y), (100, 100))), sprites.sprites['acc_snake' + accessory + cat_sprite], manager=MANAGER)
                            elif accessory in cat.pelt.smallAnimal_accessories:
                                self.cat_list_buttons["cat" + str(i)] = pygame_gui.elements.UIImage(ui_scale(pygame.Rect((100 + pos_x, 365 + pos_y), (100, 100))), sprites.sprites['acc_smallAnimal' + accessory + cat_sprite], manager=MANAGER)
                            elif accessory in cat.pelt.deadInsect_accessories:
                                self.cat_list_buttons["cat" + str(i)] = pygame_gui.elements.UIImage(ui_scale(pygame.Rect((100 + pos_x, 365 + pos_y), (100, 100))), sprites.sprites['acc_deadInsect' + accessory + cat_sprite], manager=MANAGER)
                            elif accessory in cat.pelt.aliveInsect_accessories:
                                self.cat_list_buttons["cat" + str(i)] = pygame_gui.elements.UIImage(ui_scale(pygame.Rect((100 + pos_x, 365 + pos_y), (100, 100))), sprites.sprites['acc_aliveInsect' + accessory + cat_sprite], manager=MANAGER)
                            elif accessory in cat.pelt.fruit_accessories:
                                self.cat_list_buttons["cat" + str(i)] = pygame_gui.elements.UIImage(ui_scale(pygame.Rect((100 + pos_x, 365 + pos_y), (100, 100))), sprites.sprites['acc_fruit' + accessory + cat_sprite], manager=MANAGER)
                            elif accessory in cat.pelt.crafted_accessories:
                                self.cat_list_buttons["cat" + str(i)] = pygame_gui.elements.UIImage(ui_scale(pygame.Rect((100 + pos_x, 365 + pos_y), (100, 100))), sprites.sprites['acc_crafted' + accessory + cat_sprite], manager=MANAGER)
                            elif accessory in cat.pelt.tail2_accessories:
                                self.cat_list_buttons["cat" + str(i)] = pygame_gui.elements.UIImage(ui_scale(pygame.Rect((100 + pos_x, 365 + pos_y), (100, 100))), sprites.sprites['acc_tail2' + accessory + cat_sprite], manager=MANAGER)
                            pos_x += 120
                            if pos_x >= 1100:
                                pos_x = 0
                                pos_y += 120
    ...
    def handle_tab_events(self, event):
        ...
        # Conditions Tab
            ...
            if b_data in b_2data:
                ...
                self.profile_elements["cat_info_column1"].kill()
                self.profile_elements["cat_info_column1"] = UITextBoxTweaked(self.generate_column1(self.the_cat),
                                                                    ui_scale(pygame.Rect((300, 230), (360, 380))),
                                                                    object_id=get_text_box_theme(
                                                                        "#text_box_22_horizleft"),
                                                                    line_spacing=0.95, manager=MANAGER)
    ...
    def screen_switches(self):
        ...
        self.exile_return_button = UISurfaceImageButton(
            ui_scale(pygame.Rect((25, 60), (34, 34))),
            Icon.HOUSE,
            get_button_dict(ButtonStyles.ICON, (34, 34)),
            object_id="@buttonstyles_icon",
    ...
    def build_profile(self):
        ...
        self.profile_elements["favourite_button2"] = UIImageButton(
            favorite_button_rect,
            "",
            object_id="#fav_star",
            manager=MANAGER,
        ...
        self.profile_elements["favourite_button3"] = UIImageButton(
            favorite_button_rect,
            "",
            object_id="#fav_star",
            manager=MANAGER,
        ...
        if self.the_cat.ID != game.clan.your_cat.ID:
            ...
            if self.the_cat.flirted:
                ...
                ui_scale(pygame.Rect((333, 110), (34, 34))),
                Icon.FLIRT,
                get_button_dict(ButtonStyles.ICON, (34, 34)),
                object_id="@buttonstyles_icon",
                manager=MANAGER)
        ...
        if self.the_cat.status == "leader" and not self.the_cat.dead:
            ...
            self.profile_elements["queen"] = UIImageButton(
                ui_scale(pygame.Rect((383, y_pos), (34, 34))),
                "",
         ...
         if self.the_cat.status in ["medicine cat", "medicine cat apprentice"] and self.the_cat.ID == game.clan.your_cat.ID and self.the_cat.moons >= 6:
            self.profile_elements["halfmoon"] = UIImageButton(ui_scalescale(pygame.Rect(
                (386, y_pos), (68, 68))),
                "",
    ...
    def open_faith_tab(self):
        ...
        self.faith_text = UITextBoxTweaked(self.get_faith_text(cat_faith),
                                                        ui_scale(pygame.Rect((185, 535), (425, 149))),
                                                        object_id="#text_box_26_horizleft_pad_10_14",
    ...
    def toggle_accessories_tab(self):
        ...
        if previous_open_tab == 'accessories':
            ...
            self.search_bar_image = pygame_gui.elements.UIImage(ui_scale(pygame.Rect((120, 455), (138, 34))),
                                                            pygame.image.load(
                                                                "resources/images/search_bar.png").convert_alpha(),
                                                            manager=MANAGER)
            self.search_bar = pygame_gui.elements.UITextEntryLine(ui_scale(pygame.Rect((130, 458), (103, 28))),
    ...
    def toggle_dangerous_tab(self):
        ...
        if previous_open_tab == "dangerous":
            ...
            self.murder_cat_button = UIImageButton(
                ui_scale(pygame.Rect((578, 523), (172, 36))),
                "",
            ...
            if game.clan.your_cat.joined_df:
                ...
                scale(pygame.Rect((578, 558), (172, 36))),
                "",
            ...
            self.affair_button = UIImageButton(
                scale(pygame.Rect(578, 594), (172, 36))),
                "",
    ...
    def update_disabled_buttons_and_text(self):
        ...
        # Roles Tab
            ...
            # self.change_accessory_button = UIImageButton(ui_scale(pygame.Rect((402, 1100), (344, 72))), "",
            ...
            if self.the_cat.status in ['leader', 'deputy', 'medicine cat', 'mediator', 'queen', 'warrior'] and not self.the_cat.dead and not self.the_cat.outside:
                self.request_apprentice_button = UISurfaceImageButton(
                    ui_scale(pygame.Rect((402, 550), (172, 36))), 
                    "Request Apprentice",
                    get_button_dict(ButtonStyles.LADDER_MIDDLE, (172, 36)),
                    object_id="@buttonstyles_ladder_middle",
            ...
            if (
                ...
                self.gift_accessory_button = UISurfaceImageButton(
                    ui_scale(pygame.Rect((402, 514), (172, 36))), 
                    "Gift Clanmate",
                    get_button_dict(ButtonStyles.LADDER_MIDDLE, (172, 36)),
                    object_id="@buttonstyles_ladder_middle",
                    starting_height=2,
               ...
               if not self.the_cat.outside and not self.the_cat.df:
                ...
                if game.clan.instructor.ID == self.the_cat.ID:
                    self.exile_cat_button = UIImageButton(
                        ...
                        tool_tip_text='Your Clan will go to StarClan after death.',
                        starting_height=2,
                        manager=MANAGER,
                    )
                    ...
                    self.exile_cat_button = UIImageButton(
                        ...
                        "",
                        object_id="#follow_sc_button",
                        tool_tip_text='Your Clan will go to The Dark Forest after death.',
                        starting_height=2,
                        manager=MANAGER,
                    )
        ...
        # History Tab:
            ...
            if self.open_sub_tab == "life events":
                ...
                self.genelist = str(self.the_cat.phenotype.PhenotypeOutput(self.the_cat.genotype.sex, self.the_cat.genotype.white_pattern)) + "\n" + str(self.the_cat.genotype.ShowGenes(game.settings["filter genes"])) + "\n" + self.the_cat.genotype.FormatSomatic()
                if(self.the_cat.genotype.chimera):
